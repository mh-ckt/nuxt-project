<template>
  <div>
    <ProvinceCitySelector :provinces="provinces" :mockData="mockData" @update:province="province = $event"
...
import ProvinceCitySelector from '@/components/cases/CommonSelect.vue'
